...
public class PlantImpl extends AbstractEntity implements Plant {
    ...
    public PlantImpl(final PlantActionStrategy strategy, final PlantType plantType, final Position position) {
        super(position);
